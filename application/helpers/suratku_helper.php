...
if (!function_exists('load_page')) {
	function load_page($page_path = null,  $page_title = '', $data = [])
	{
		...
		$CI->load->view('pages/components/header', $data);
		$CI->load->view('pages/components/sidebar', $data);
		$CI->load->view('pages/components/topbar', $data);
		
		$CI->load->view('pages/components/content', $data);
		
		$CI->load->view('pages/components/footer', $data);
	}
}
...
if (!function_exists('ubahFormatBulan')) {
	function ubahFormatBulan($str)
	{
